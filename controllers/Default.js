...
module.exports.userUser_idPostPUT = function userUser_idPostPUT (_, res, next, body, song_lyrics, song_album_cover, song_canvas, user_id) {
...
module.exports.userUser_idFollowingFollowing_idPostPost_idCommentComment_idPUT = function userUser_idFollowingFollowing_idPostPost_idCommentComment_idPUT (_, res, next, user_id, following_id, post_id, comment_id, like, reply, report) {
